...
| Phase 17 | Smart Learning Pathways — recommendation engine, unified topic routing, My Map action plan redesign, parent focus override | Planned (Features 61-64) |
...
|---------|-------------|--------|
| Feature 61 | Topic Recommendation Engine — backend API that computes recommended action (Learn/Practice/Tutor) per topic using diagnostics, lesson history, practice patterns, stuck detection | Planned |
| Feature 62 | Smart Topic Routing UI — unified topic view with action badges, routing prompt with recommended path + alternative, replaces separate Expedition/Practice pickers | Planned |
| Feature 63 | My Map Action Plan Redesign — transforms My Map from navigation menu to personalized per-subject action plan with prioritized next steps | Planned |
| Feature 64 | Parent Focus Override — parents can set a "Focus this week" subject to boost priority in the action plan | Planned |
